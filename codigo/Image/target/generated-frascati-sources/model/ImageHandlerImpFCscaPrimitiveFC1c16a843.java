 ...
 * on: Sun Dec 01 02:36:33 COT 2019
 */

package model;


public class ImageHandlerImpFCscaPrimitiveFC1c16a843
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new interfaces.TaskDistributorInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new interfaces.TaskDistributorFcOutItf(proxyForCompCtrl,"taskDistributor",new org.objectweb.fractal.julia.type.BasicInterfaceType("taskDistributor","interfaces.TaskDistributor",true,true,false),false,intercept);
