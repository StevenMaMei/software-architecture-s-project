...
public class ImageHandlerInterceptorSCALCb56bb98SCACCIntent
...
implements interfaces.ImageHandler,org.objectweb.fractal.julia.Interceptor {
  ...
  public ImageHandlerInterceptorSCALCb56bb98SCACCIntent()  {
  }

  private ImageHandlerInterceptorSCALCb56bb98SCACCIntent(Object obj)  {
  ...
  public Object clone()  {
    ImageHandlerInterceptorSCALCb56bb98SCACCIntent clone = new ImageHandlerInterceptorSCALCb56bb98SCACCIntent(getFcItfDelegate());
    initFcClone(clone);
    clone._lc = _lc;
  ...
  public void ProcessImage(final byte[] arg0,final double arg1)  {
    synchronized(_lc)
    {
      ...
      try {
    interfaces.ImageHandler impl = pushFcAndGet("imageHandler",interfaces.ImageHandler.class,this);
    try {
