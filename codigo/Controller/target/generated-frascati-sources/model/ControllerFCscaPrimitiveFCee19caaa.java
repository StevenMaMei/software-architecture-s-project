...
public class ControllerFCscaPrimitiveFCee19caaa
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("r","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("imageHandler","interfaces.ImageHandler",true,true,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("inputImage","interfaces.InputImage",true,true,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new interfaces.InputImageInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new interfaces.InputImageFcOutItf(proxyForCompCtrl,"inputImage",new org.objectweb.fractal.julia.type.BasicInterfaceType("inputImage","interfaces.InputImage",true,true,false),false,intercept);
    ic.interfaces.put("inputImage",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    initFcController(ic);
