...
public class RotationFCscaPrimitiveFC2f092fbe
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("iRotation","interfaces.IRotation",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("observer","interfaces.Observer",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("subject","interfaces.Subject",true,true,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("imageHandler","interfaces.ImageHandler",true,true,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.content = model.Rotation.class;
    ...
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new interfaces.ImageHandlerInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new interfaces.ImageHandlerFcOutItf(proxyForCompCtrl,"imageHandler",new org.objectweb.fractal.julia.type.BasicInterfaceType("imageHandler","interfaces.ImageHandler",true,true,false),false,intercept);
  ...
  public org.objectweb.fractal.api.Component newFcControllerInstantiation(org.objectweb.fractal.julia.InitializationContext ic) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.controllers.add(ctrl = new model.RotationFCSCAContentControllerImpl());
